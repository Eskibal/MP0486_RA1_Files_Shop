...
public class ShopView extends JFrame implements ActionListener, KeyListener{
	...
	public void openExportConfirm() {
		boolean export = shop.writeInventory();
		
		if (export != false) {
			JOptionPane.showMessageDialog(null, "Inventario exportado correctamente",  "Informacion", JOptionPane.INFORMATION_MESSAGE);
		} else {
			JOptionPane.showMessageDialog(null, "Error exportando el inventario",  "Error", JOptionPane.ERROR_MESSAGE);
		}
	}
